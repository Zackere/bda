...
sqlcmd="${sqlcmd}CREATE TABLE modelpredictions (id STRING, ts TIMESTAMP, prediction INT, actual INT, weatherid STRING, pollutionid STRING) STORED AS ORC LOCATION 'hdfs://namenode:8020/user/nifi/modelpredictions';"
