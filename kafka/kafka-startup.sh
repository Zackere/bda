...
for extra_topic in error spark modelweights modelEvaluation
do
...
do
    ...
    ./bin/kafka-topics.sh --create   --topic "data$city"   --bootstrap-server localhost:9092 --partitions 1 --replication-factor 1
    ./bin/kafka-topics.sh --describe --topic "data$city"   --bootstrap-server localhost:9092
